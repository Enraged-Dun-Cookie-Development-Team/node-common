...
function createBaseLogRequest(): LogRequest {
  return { server: 0, type: 0, manual: false, info: "", extra: "" };
}
...
export const LogRequest = {
  ...
  fromJSON(object: any): LogRequest {
    return {
      ...
      type: isSet(object.type) ? logRequest_LogTypeFromJSON(object.type) : 0,
  ...
  toJSON(message: LogRequest): unknown {
    ...
    message.type !== undefined && (obj.type = logRequest_LogTypeToJSON(message.type));
